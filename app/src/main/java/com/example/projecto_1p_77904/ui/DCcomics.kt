...
class DCcomics : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_dccomics)
        ...
        categoriesRecyclerView.adapter = CategoryAdapter(Category.dcheroes)
        ...
        logout.setOnClickListener{
            ...
            val intent = Intent(this@DCcomics, MainActivity::class.java)
